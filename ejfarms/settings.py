"""
Django settings for ejfarms project.
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'ejfarms.onrender.com']
...
WSGI_APPLICATION = 'ejfarms.wsgi.application'
